...
-- ============ 20260803010000_profiles_profile_billing_columns.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ============ 20260806000000_volunteer_shifts_hours.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ============ 20260806010000_volunteer_hours_verify_guard_fix.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ============ 20260807000000_organizations_multitenancy.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ============ 20260823000000_custom_domains.sql ============
...
-- ============ 20260823500000_profiles_role_replay_compatibility.sql ============
...
-- ============ 20260824000000_cause_stories.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
drop policy if exists cause_stories_public_read on public.cause_stories;
create policy cause_stories_public_read on public.cause_stories for select
...
drop policy if exists cause_stories_admin_write on public.cause_stories;
create policy cause_stories_admin_write on public.cause_stories for all
  using (
    exists (
...
-- ============ 20260825000000_cause_impact_stats.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
drop policy if exists cause_impact_stats_public_read on public.cause_impact_stats;
create policy cause_impact_stats_public_read on public.cause_impact_stats for select
  using (published = true);
...
drop policy if exists cause_impact_stats_admin_write on public.cause_impact_stats;
create policy cause_impact_stats_admin_write on public.cause_impact_stats for all
  using (
...
-- ============ 20260826000000_platform_reports.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
drop policy if exists platform_reports_public_read on public.platform_reports;
create policy platform_reports_public_read on public.platform_reports for select
...
drop policy if exists platform_reports_admin_write on public.platform_reports;
create policy platform_reports_admin_write on public.platform_reports for all
  using (
    exists (select 1 from public.profiles p
            where p.id = auth.uid() and p.role in ('admin', 'super_admin'))
  )
...
drop policy if exists "reports_admin_write" on storage.objects;
create policy "reports_admin_write" on storage.objects for all
  using (
    bucket_id = 'reports'
...
-- ============ 20260827000000_campaign_path.sql ============
-- ─────────────────────────────────────────────────────────────────────────────
...
begin
  if not exists (
    ...
    alter table public.campaigns drop constraint if exists campaigns_campaign_path_check;
alter table public.campaigns add constraint campaigns_campaign_path_check
...
-- ============ 20260828000000_repair_editorial_admin_policies.sql ============
...
-- ============ 20260829000000_reconcile_live_schema_columns.sql ============
...
begin
  ...
  then
    alter table public.campaign_reports drop constraint if exists campaign_reports_resolved_by_fkey;
alter table public.campaign_reports add constraint campaign_reports_resolved_by_fkey
  ...
  then
    alter table public.donor_crm_contacts drop constraint if exists donor_crm_contacts_donor_id_fkey;
alter table public.donor_crm_contacts add constraint donor_crm_contacts_donor_id_fkey
  ...
  then
    alter table public.membership_tiers drop constraint if exists membership_tiers_interval_check;
alter table public.membership_tiers add constraint membership_tiers_interval_check
  ...
  then
    alter table public.nonprofit_profiles drop constraint if exists nonprofit_profiles_ein_key;
alter table public.nonprofit_profiles add constraint nonprofit_profiles_ein_key unique (ein);
  end if;
  ...
  then
    alter table public.refunds drop constraint if exists refunds_requested_by_fkey;
...
alter table public.team_members add constraint team_members_invited_by_fkey
  ...
  then
    alter table public.trust_scores drop constraint if exists trust_scores_activity_score_check;
alter table public.trust_scores add constraint trust_scores_activity_score_check check (activity_score >= 0 and activity_score <= 25);
  end if;
  ...
  then
    alter table public.trust_scores drop constraint if exists trust_scores_identity_score_check;
alter table public.trust_scores add constraint trust_scores_identity_score_check check (identity_score >= 0 and identity_score <= 25);
  end if;
  ...
  then
    alter table public.trust_scores drop constraint if exists trust_scores_story_score_check;
alter table public.trust_scores add constraint trust_scores_story_score_check check (story_score >= 0 and story_score <= 25);
  end if;
  ...
  then
    alter table public.trust_scores drop constraint if exists trust_scores_transparency_score_check;
alter table public.trust_scores add constraint trust_scores_transparency_score_check check (transparency_score >= 0 and transparency_score <= 25);
  end if;
...
alter table public.verification_documents add constraint verification_documents_doc_type_check
  ...
  then
    alter table public.verification_documents drop constraint if exists verification_documents_verified_by_fkey;
alter table public.verification_documents add constraint verification_documents_verified_by_fkey
