-- Rollback for 20260818000000_profile_market_locale.sql
--
...
--
-- Contents MEASURED, not parsed: `scripts/diff-migration.sh 20260818000000` replays every
...
alter table if exists public.profiles drop column if exists locale;
