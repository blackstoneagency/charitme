-- Rollback for 20260817000000_campaign_geolocation.sql
--
...
--
-- Contents MEASURED, not parsed: `scripts/diff-migration.sh 20260817000000` replays every
...
alter table if exists public.campaigns drop column if exists latitude;
alter table if exists public.campaigns drop column if exists longitude;
