...
- [~] CHAR-0017 - **Campaign Builder hardening in progress**
  ...
  - Current verification: 52 web test files, 791 tests passing after adding privacy-aware public donor profile structured data; production build remains green from the preceding verification.
  - Priority: P0
