...
- [~] CHAR-0017 - **Campaign Builder hardening in progress**
  ...
  - Completion Evidence: server-authoritative active/draft state transitions, private draft enforcement, non-public campaign noindex/owner gating, 5 MB media alignment, and Stripe Connect readiness required for publication; typecheck, focused campaign/SEO/AEO/marketing tests (61), and production build passed on 2026-07-22
  - Commit: in progress
