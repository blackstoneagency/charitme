...
for (const theme of ['light', 'dark']) {
  ...
  for (const r of list) {
    ...
    try {
      ...
      // SKIPPED rather than failed; sharing the list means this audit agrees
      // with them instead of aborting on every run for a route the suite
      // deliberately tolerates.
      //
      // This was not hypothetical: `/campaigns/security-header-fixture/embed`
