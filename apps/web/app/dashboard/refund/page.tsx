    ...
    return (
      <CharitMeShell active="Refund">
        ...
        <div className="kf-admin-dash" style={{ maxWidth: 640 }}>
          <DegradedReadNotice title="We couldn't load your refundable donations">
            No refund request has been submitted. Your donation records are unaffected. Reload the page to try again.
          </DegradedReadNotice>
        </div>
      </CharitMeShell>
    );
  ...
  if (refundsError || !existingRefunds) {
    return (
      <CharitMeShell active="Refund">
        ...
        />
        <div className="kf-admin-dash" style={{ maxWidth: 640 }}>
          <DegradedReadNotice title="We couldn't verify your refund eligibility">
            No refund request has been submitted. Reload the page before trying again so we can prevent duplicate requests.
          </DegradedReadNotice>
        </div>
      </CharitMeShell>
    );
    ...
    <CharitMeShell active="Refund">
      ...
      <div className="kf-admin-dash">
        {(campaignError || !campaignData) && (
          <DegradedReadNotice title="Some campaign details are temporarily unavailable">
            Your refundable donations are current and you can still submit a request, but some campaign names could not be loaded.
          </DegradedReadNotice>
        )}
