  ...
  return (
    <CharitMeShell active="Marketing" mode="admin">
      <TopBar
        ...
        actions={<Link href="/admin/marketing" style={{ height: 38, display: 'inline-flex', alignItems: 'center', padding: '0 16px', borderRadius: 10, background: 'var(--s2)', color: 'var(--t1)', border: '1px solid #e2e8f0', fontWeight: 700, fontSize: 13, textDecoration: 'none' }}>← Marketing</Link>}
      />
      <GoalsClient />
    </CharitMeShell>
  );
