...
export const metadata: Metadata = {
  ...
  description: 'GiveRise makes personal fundraising for medical bills, emergencies, memorials, and family needs simple, trusted, and fast — with a free AI Copilot and 0% platform fee.',
};
...
const INDIVIDUAL_FAQS = [
  {
    ...
    a: 'No. Creating and running a campaign is completely free. GiveRise charges 0% mandatory platform fee. Donors can optionally add a support tip at checkout.',
  },
  {
      ...
      <section className="py-16">
        <div className="container">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-slate-600">GiveRise supports personal, emergency, and community fundraisers across all major categories.</p>
          </div>
      ...
      <section className="bg-slate-50 py-16">
        <div className="container">
          <div className="mb-12">
            ...
            <p className="mt-3 text-slate-600">No fundraising experience needed. GiveRise guides you through every step.</p>
          </div>
