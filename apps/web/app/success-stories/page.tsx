            ...
            <Link href={`/campaigns/${featured.slug}`} style={{ textDecoration: 'none', display: 'block' }}>
              <div className="ss-featured-grid">
                ...
                <div>
                  ...
                  <span style={{ display: 'inline-flex', alignItems: 'center', gap: 8, height: 46, padding: '0 24px', borderRadius: 12, background: 'linear-gradient(135deg, var(--cta-from, #6736ff), var(--cta-to, #bd33cd))', color: '#fff', fontWeight: 900, fontSize: 14 }}>
                    View Full Story &#8594;
                  </span>
                </div>
              </div>
