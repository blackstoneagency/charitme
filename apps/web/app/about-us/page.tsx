...
export const metadata: Metadata = {
  title: 'About Us',
  description: 'Learn about KindFund and our mission to make fundraising smarter, safer, and more human.',
};
  ...
  return (
    <div className="pub-page simple-public">
      <section>
        ...
        <p>KindFund combines compassionate design, transparent giving tools, and AI-powered guidance so more organizers can turn real stories into real impact.</p>
      ...
      <section className="simple-grid">
        {[
          ...
          ['globe', 'Built for impact', 'From families to nonprofits, KindFund gives every cause the tools to grow responsibly.'],
        ].map(([icon, title, body]) => (
