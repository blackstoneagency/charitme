...
export const metadata: Metadata = {
  title: 'FAQ',
  description: 'Answers to the most common questions about GiveRise — fees, payouts, AI tools, trust scores, and donor safety.',
};
...
const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { q: 'What is the platform fee?', a: 'GiveRise charges 0% mandatory platform fee. We earn only from optional donor support tips that donors choose to add at checkout. The default tip is 8% of the donation amount, but donors can change it to any amount including $0.' },
      { q: 'What does Stripe charge?', a: 'Stripe charges 2.9% + $0.30 per transaction for standard card payments. This is Stripe\'s fee, not GiveRise\'s. Donors can optionally check a box at checkout to cover this fee so 100% of their stated donation reaches you.' },
      { q: 'How does the optional donor tip work?', a: 'At checkout, donors see a transparent breakdown showing exactly how much goes to the campaign, how much covers processing, and the optional tip to GiveRise. The tip is pre-filled at 8% but the donor can change it to 0%, 5%, 10%, 12%, or any custom amount before paying.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Can someone outside the US receive payouts?', a: 'GiveRise supports payouts in all countries where Stripe Express is available — over 40 countries. Payout availability, timing, and currency depend on your country and Stripe Connect rules.' },
  ...
  },
  {
    ...
    items: [
      ...
      { q: 'Can I get a refund?', a: 'Refund policies depend on the campaign organizer. Contact the organizer first. If a campaign is found to be fraudulent, GiveRise will work with Stripe to issue refunds. Report a campaign if you believe it is fraudulent.' },
      { q: 'Is my payment information secure?', a: 'Yes. All payments are processed by Stripe, a PCI DSS Level 1 certified payment processor. GiveRise never sees, stores, or handles your card number, CVV, or bank account details.' },
    ],
  },
];
