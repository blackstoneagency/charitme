...
const posts = [
  ...
  { tag: 'Nonprofits', title: 'Recurring donations for nonprofits', body: 'How to turn one-time supporters into long-term recurring donors with CharitMe.', href: '/for-nonprofits' },
  { tag: 'Payouts', title: 'How fast payouts work on CharitMe', body: 'Standard, same-day, and instant payout options explained — and how to qualify.', href: '/fast-payouts' },
