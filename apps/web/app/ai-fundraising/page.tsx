...
const TOOLS = [
  ...
  { icon: 'mail',  color: 'var(--orange-text)',                ctaColor: 'var(--orange-text, #a05712)',bg: 'rgba(245,158,11,.10)',  title: 'AI Email Generator',    body: 'Generate personalized, high-converting emails that get more opens, clicks, and replies.',    cta: 'Try it now'   },
