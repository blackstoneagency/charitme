...
export const metadata: Metadata = {
  ...
  description: 'GiveRise gives every donor AI-computed trust scores, transparent fee breakdowns, anonymous giving, receipts, and impact updates — so you can give confidently.',
};
...
const DONOR_FEATURES = [
  ...
  },
  {
    ...
    body: 'See exactly where every dollar goes before you pay — how much reaches the campaign, what Stripe charges, and the optional GiveRise tip you control.',
  },
  {
    icon: '🕶️',
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
              GiveRise shows you trust scores, verification badges, transparent fee breakdowns, and impact updates —
      ...
      <section className="py-16">
        <div className="container">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-slate-600">GiveRise was built to protect donors first. Every feature below is available on every campaign — free, public, and automatic.</p>
          </div>
        ...
        <div className="container">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-slate-600">
              Before you confirm payment, GiveRise shows you a complete fee breakdown. No hidden charges.
            </p>
          </div>
          <div className="mx-auto max-w-lg rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <div className="space-y-3">
              {[
                ...
                { label: 'Optional GiveRise tip', value: '$8.00', color: 'text-slate-600', note: 'Default 8% — change to $0' },
              ].map((row) => (
