        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
              CharitMe computes a public AI trust score for every campaign from identity, story, evidence, and donor signals —
      ...
      <section className="py-16">
        <div className="container">
          <div className="mb-10 max-w-2xl">
            ...
            <p className="mt-3 text-slate-600">Every CharitMe campaign is evaluated across six evidence-based dimensions. Donors see the score and the signals publicly.</p>
          </div>
        ...
        <div className="container">
          <div className="grid gap-10 lg:grid-cols-2">
            <div className="rounded-3xl border border-emerald-200 bg-emerald-50 p-8">
              ...
              <Link href="/create/choose-path" className="mt-6 inline-block rounded-xl bg-emerald-700 px-6 py-3 text-sm font-black text-white">
            ...
            <div className="rounded-3xl border border-blue-200 bg-blue-50 p-8">
              ...
              <p className="mt-3 text-slate-600 leading-7">
                ...
                Your payment information is never stored by CharitMe.
              </p>
