...
const ARTICLES: Article[] = [
  ...
  { id: 'gs-2', category: 'getting-started', question: 'Is it free to create a campaign?', answer: 'Yes. Creating and running a campaign is completely free. KindFund charges 0% mandatory platform fee. Donors can choose to add an optional support tip (default 8%, changeable to $0) at checkout.' },
  ...
  { id: 'gs-5', category: 'getting-started', question: 'What categories can I fundraise for?', answer: 'KindFund supports Medical, Memorial/Funeral, Emergency, Disaster Relief, Education, Animal/Pet, Community, Nonprofit, Sports/Teams, and more. Choose the category that best fits your need during campaign creation.' },
  ...
  { id: 'don-3', category: 'donations', question: 'Can I set up recurring monthly donations?', answer: 'Yes. KindFund supports monthly recurring donations with 0% platform fee — compared to GoFundMe\'s 5% recurring donor fee. Toggle "Give Monthly" on the campaign donate button, then cancel any time from your donor dashboard.' },
  { id: 'don-4', category: 'donations', question: 'What fees does Stripe charge?', answer: 'Stripe charges 2.9% + $0.30 per card transaction (standard US rate). You can optionally check "Cover processing fee" to absorb this so 100% of your stated donation reaches the campaign. KindFund does not add any markup on top of Stripe fees.' },
  ...
  { id: 'pay-3', category: 'payouts', question: 'Is there a payout fee?', answer: 'Standard payouts (3–5 business days) are free. Same-day payouts cost 1.5% of the payout amount (Stripe fee). Instant payouts cost 1.5% (minimum $0.50). KindFund does not charge additional payout fees.' },
  ...
  // Trust & Safety
  { id: 'ts-1', category: 'trust-safety', question: 'What is the KindFund Trust Score?', answer: 'The Trust Score (0–100) is computed automatically from identity verification, story quality, evidence uploads, fundraising activity, and donor signals. A higher score builds donor confidence. Scores are visible on every campaign page.' },
  ...
  { id: 'ts-3', category: 'trust-safety', question: 'What is the KindFund Protection Promise?', answer: 'KindFund\'s Protection Promise means: (1) fees are always shown before checkout, (2) identity is verified via Stripe KYC before payouts, (3) suspicious campaigns are reviewed and held, (4) we work with Stripe on refunds for verified fraudulent campaigns.' },
