...
export const metadata: Metadata = {
  ...
  description: 'GiveRise uses Stripe Connect Express to deliver donations to fundraisers. Standard payouts are free. Same-day and instant payouts are available for eligible verified users.',
};
...
const VERIFICATION_STEPS = [
  {
    ...
    body: 'Click "Connect payouts" from your dashboard. GiveRise opens the Stripe Express onboarding flow — takes 2–3 minutes for most users.',
  },
  {
    step: '02',
    icon: '🪪',
...
const PAYOUT_FAQS = [
  ...
  },
  {
    ...
    a: 'GiveRise supports payouts in all countries where Stripe Connect Express is available — 40+ countries. Payout timing, currency, and method depend on your country and Stripe Connect rules.',
  },
  {
  ...
  {
    q: 'Does GiveRise ever hold my money?',
    a: 'GiveRise is not a money transmitter and does not hold campaign funds. Donations are processed by Stripe and held in your Stripe Connect balance until payout. GiveRise instructs Stripe to transfer funds on the schedule you choose.',
  },
];
        ...
        <div className="container">
          <div className="max-w-3xl">
            ...
            <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-600">
              GiveRise uses Stripe Connect Express to deliver funds directly to your bank.
          ...
          <div className="grid gap-10 lg:grid-cols-2">
            <div>
              ...
              <p className="mt-4 leading-7 text-slate-600">
                GiveRise uses Stripe Connect Express to process and deliver all donations.
                Stripe is a PCI DSS Level 1 certified payment processor used by Amazon, Google, and Shopify.
                GiveRise never sees, stores, or handles your bank account or card details.
              </p>
