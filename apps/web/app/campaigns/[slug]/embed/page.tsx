...
export default async function CampaignEmbedPage({ params }: Props) {
  ...
  return (
    <div style={{ padding: 20, maxWidth: 400, fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", background: '#fff', color: '#1a1a2e' }}>
      ...
      <h2 style={{ margin: '0 0 4px', fontSize: 18, fontWeight: 900, color: '#1a1a2e', lineHeight: 1.3 }}>
        {campaign.title}
      </h2>
      {campaign.tagline && (
        <p style={{ margin: '0 0 14px', fontSize: 13, color: '#64748b' }}>{campaign.tagline}</p>
      )}
