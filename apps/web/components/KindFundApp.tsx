...
const dashboardNav = [
  ...
  ['Updates', '/dashboard/updates', 'doc', '12'],
  ['Payouts', '/dashboard/payouts', 'wallet'],
  ['Analytics', '/dashboard/analytics', 'chart'],
  ['Messages', '/dashboard/messages', 'chat', '8'],
  ['Team', '/dashboard/team', 'team', '3'],
...
export function Logo() {
  return (
    <Link href="/" className="kf-logo">
      <span><i /><b /></span>
      <div><strong>KindFund</strong><small>Fundraising that thinks for you.</small></div>
    </Link>
  );
}

export function KindFundShell({ active, children, mode = 'dashboard', hasAdminAccess = false, userName, userEmail, userRole, userAvatarUrl }: ShellProps) {
    ...
    <div className="kf-app">
      <aside className="kf-sidebar">
        ...
        <div className="kf-pro">
          <div><KFIcon name="crown" /> KindFund Pro</div>
...
export function PageScaffold({ active, title, subtitle, metrics, rows, tabs, side = true, mode = 'dashboard', children, userName, userEmail }: {
  ...
  return (
    <KindFundShell active={active} mode={mode} userName={userName} userEmail={userEmail}>
...
export function FlowPage({ title, subtitle, mode = 'dashboard', active = 'Dashboard', steps }: { title: string; subtitle: string; mode?: 'dashboard' | 'admin'; active?: string; steps: string[] }) {
  return (
    <KindFundShell active={active} mode={mode}>
