...
const dashboardNav = [
  ...
  ['Matching Gifts', '/dashboard/matching-gifts', 'crown'],
  ['Corporate Giving', '/dashboard/corporate', 'stack'],
  ['Grants', '/dashboard/grants', 'audit'],
  ['Volunteering', '/dashboard/volunteer', 'team'],
  ['Sponsorships', '/dashboard/sponsorships', 'crown'],
  ['Events', '/dashboard/events', 'stack'],
  ['Challenges', '/dashboard/challenges', 'crown'],
  ['Referrals', '/dashboard/referrals', 'crown'],
  ['Privacy', '/dashboard/privacy', 'audit'],
...
const adminNav = [
  ...
  ['Challenges', '/admin/challenges', 'crown'],
