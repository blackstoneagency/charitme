...
export async function middleware(request: NextRequest) {
  ...
  const contentSecurityPolicy = [
    ...
    "img-src 'self' data: blob: https://*.supabase.co https://images.unsplash.com https://loremflickr.com https://picsum.photos https://fastly.picsum.photos https://api.dicebear.com https://api.qrserver.com",
    "font-src 'self' data:",
