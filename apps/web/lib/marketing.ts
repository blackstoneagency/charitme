...
export const MARKETING_PAGES: MarketingPage[] = [
  {
    ...
    description: 'GiveRise is free to start, free to run, and clear about every dollar before checkout.',
    points: ['0% mandatory platform fee', 'Optional GiveRise support tips', 'Premium AI tools for teams', 'Fast payout fees only when eligible users choose speed'],
    cta: 'Compare plans',
  },
  {
    slug: 'how-it-works',
    ...
    description: 'GiveRise keeps campaign creation simple while adding trust checks, AI optimization, and payout transparency behind the scenes.',
  ...
  },
  {
    ...
    description: 'GiveRise supports donor CRM, recurring donations, tax receipts, campaigns, events, and analytics.',
  ...
  },
  {
    ...
    description: 'Learn how GiveRise handles fees, payouts, tips, trust scores, verification, AI tools, and donor receipts.',
  ...
  },
  {
    slug: 'contact',
    eyebrow: 'Contact',
    title: 'Talk with the GiveRise team.',
