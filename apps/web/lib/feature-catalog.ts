...
export const PLATFORM_MODULES: PlatformModule[] = [
  ...
  },
  {
    ...
    audience: 'Every GiveRise organizer, donor, nonprofit, creator, and admin',
    status: 'Live',
    ...
    features: [
      { competitor: 'GiveRise', name: 'AI Campaign Writer', description: 'Creates titles, stories, updates, FAQs, email appeals, SMS copy, and donation tiers.' },
      { competitor: 'GiveRise', name: 'AI Trust Score', description: 'Public trust status gives donors clear confidence signals.' },
      { competitor: 'GiveRise', name: 'AI Fraud Detection', description: 'Flags duplicate text, suspicious patterns, risky payout requests, and verification gaps.' },
      { competitor: 'GiveRise', name: 'AI Social Media Generation', description: 'Creates captions, long-form posts, share kits, and timing recommendations.' },
      { competitor: 'GiveRise', name: 'AI Donor Targeting', description: 'Segments donors and recommends outreach actions.' },
      { competitor: 'GiveRise', name: 'AI Campaign Health Score', description: 'Predicts success and recommends improvements.' },
      { competitor: 'GiveRise', name: 'AI Transparency Ledger', description: 'Summarizes receipts, milestones, expenses, payouts, and impact updates.' },
      { competitor: 'GiveRise', name: 'AI Payout Risk Engine', description: 'Enables safer standard, same-day, and instant payouts for verified users.' },
    ],
  },
];
