...
describe('a generated cover is overridable, an upload is not', () => {
  ...
  it('replaces first-party generated art with a verified catalog photo', async () => {
    const generated = '/media/subject?category=Medical&key=migration-20260903-campaign-1-49b50f84';
    const resolved = await resolveCampaignCover(generated, 'Medical', 'campaign-1');
    expect(resolved).not.toBe(generated);
    expect(resolved).toMatch(/^https:\/\/images\.unsplash\.com\/photo-/);
  });
