...
describe('optimizedCoverUrl', () => {
  ...
  it('leaves user uploads and unknown hosts unchanged', () => {
    const upload = 'https://xyz.supabase.co/storage/v1/object/public/campaign-images/a.png';
    expect(optimizedCoverUrl(upload, 400)).toBe(upload);
