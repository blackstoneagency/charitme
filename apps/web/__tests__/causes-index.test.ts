...
// Moved out of `app/causes/` when /success-stories grew the same newsletter
// band. One component, two callers — a second hand-maintained copy is how this
// repo's category list drifted three ways.
